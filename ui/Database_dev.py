...
class Database:
    ...
    def read_data():
        ...
        all_locations_obj = LocationList(LocationList.ALL_LOCATIONS, [hebo, hcrhst, region6, umatilla, siuslaw])

        all_locations_list = [hebo, hcrhst, region6, umatilla]
        all_location_categories = [rst, regional, all_locations_obj, forests]
